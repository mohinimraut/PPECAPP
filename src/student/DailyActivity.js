                                                            ...
                                                            <View>
                                                                {
                                                                    ...
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out"style={{flexDirection:'row',height:40}}>
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{paddingLeft:10,width:'35%',justifyContent:'flex-end'}}>
                                                                      <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{fontWeight:"bold"}}>Subject</Animatable.Text>
                                                                      </Animatable.View >
                                                                      <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{width:'65%',justifyContent:'flex-end'}}>
                                                                        {data.subject_Name=='' ? <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">-----</Animatable.Text> 
                                                                        :<Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">{ activity.subject_Name}</Animatable.Text>}
                                                                    ...
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{flexDirection:'row',height:40}}>
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{paddingLeft:10,width:'35%',justifyContent:'flex-end'}}>
                                                                        <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{fontWeight:"bold"}}>Activity</Animatable.Text>
                                                                      </Animatable.View >
                                                                      <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{width:'65%',justifyContent:'flex-end'}}>
                                                                      {data.teacher_Name=='' ? <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">-----</Animatable.Text>
                                                                       :<Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">{ activity.teacher_Name}</Animatable.Text>}
                                                                      </Animatable.View >
                                                      
                                                                    </Animatable.View >
                                                                    <View   style={{height:1,backgroundColor:"#bdbdbd",marginLeft:15,marginRight:15}}></View >
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{flexDirection:'row',paddingTop:20}}>
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{paddingLeft:10,width:'35%',justifyContent:'flex-end'}}>
                                                                        <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{fontWeight:"bold"}}>Homework</Animatable.Text>
                                                                      </Animatable.View >
                                                                      <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{width:'65%',justifyContent:'flex-end'}}>
                                                                      {data.homework=='' ? <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">-----</Animatable.Text> 
                                                                      :<Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">{activity.activity}</Animatable.Text>}
                                                                      </Animatable.View >
                                                      
                                                                    </Animatable.View >
                                                                    <View style={{height:1,backgroundColor:"#bdbdbd",marginLeft:15,marginRight:15}}></View>
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{height:50,flexDirection:'row',flex:1}}>
                                                                    <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{paddingLeft:10,width:'55%',justifyContent:'center'}}>
                                                                        <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{fontWeight:"bold"}}>By {activity.teacher_Name}</Animatable.Text>
                                                                      </Animatable.View >
                                                                      <Animatable.View  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out" style={{width:'45%',justifyContent:'center'}}>
                                                                      {data.extra2=='' ? <Animatable.Text  animation="zoomIn" delay={300} useNativeDriver={true} easing="ease-out">-----</Animatable.Text> 
