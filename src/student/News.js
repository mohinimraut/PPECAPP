...
import {View ,Text,TouchableOpacity,Platform,Linking, LinkingIOS,StatusBar,Image} from 'react-native';
...
homebody()
{
    return(
        <View>
            {this.state.newsdata.length >0  && typeof this.state.newsdata=='object'? 
            <View>
                <ScrollView>
            {
            ...
            }</ScrollView></View>:this.state.loading?<Loader/>:<Nodata/> }
