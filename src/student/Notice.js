...
import {View ,Text,TouchableOpacity,ActivityIndicator,Platform,Linking, LinkingIOS,StatusBar,Image} from 'react-native';
...
async Newsdataapi()
{
    ...
    var responce=await  Noticedataapi(this.state.stud_id)
    this.setState({
                       newsdata:responce
                  })
                 ...
                 console.log( 'gfsdfgsgdsf'+time)
                    ...
                    return(
                        ...
                        <View style={{flex:1,backgroundColor:'#eceff1',marginTop:15,marginLeft:15,marginRight:15}}>
                            ...
                            <View style={{paddingLeft:20,paddingBottom:15,paddingTop:10,paddingRight:5}}><Text style={{fontWeight:'bold'}}>{data.noticetext}</Text></View>
                        ...
                        <View style={{justifyContent:'center',paddingLeft:30}}>{data.noticefileurl=="" ?<View></View> :<TouchableOpacity  onPress={() =>{ this.handleurl(data.noticefileurl)}}><Image style={{height:25,width:25}} source={require('../../assets/Images/DrawerImages/linknew.png')}></Image></TouchableOpacity> }</View>
                        </View>
                       </View>
                    )
                }))
            ...
            <Container>
                ...
                <Header style={{backgroundColor:"white"}}>
                    ...
                    <View style={{flex:1,justifyContent:"center",paddingLeft:30}}>
                       <Text style={{color:"#ff7043",fontWeight:"bold",fontSize:20}}>Notice</Text>
                    </View>
                </Header>
