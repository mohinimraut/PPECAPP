...
import { View, Dimensions,ScrollView, Image, Text, ImageBackground, StyleSheet, TouchableOpacity,StatusBar,Alert,NetInfo,Keyboard } from 'react-native'
import {
...
export default class Home extends Component {
  ...
  async getlogintype(){
    ...
    db.transaction((txn) => {
      ...
      function(tx, result) {
        ...
        self.setState({logintype:data.LoginType,fname:data.fname,username:data.username,pwd:data.password,role_id:data.role_id})
  ...
  render() {
    console.log('fshfnfnj,dnsdfgj,sd'+this.state.logintype +this.state.logintype)
 ...
 <TouchableOpacity onPress={() => this.state.logintype=='2' ? this.props.navigation.navigate('StaffDailyActivity') :this.props.navigation.navigate('DailyActivity')}>
        ...
        <View style={styles.list}>
          ...
          <View style={{
            ...
            <TouchableOpacity onPress={() => this.state.logintype=='3' ? this.props.navigation.navigate('Admission') :alert('you are not authorized to access ')}>
