...
import Stafffees from '../staff/stafffee';
import RollId from '../staff/RollId';
import FetchMobile from '../staff/FetchMobile';

FetchMobile
const StackScreen = createStackNavigator({
Home: {screen: Home},
Stafffees: {screen: Stafffees},
