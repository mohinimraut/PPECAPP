...
{
  console.log(BaseAPI+'student?studid='+userid)
  try {
...
export const classdata1=async(userid)=>
{
  try {
    const response = await fetch(BaseAPI+'MobileApp/getstaffclass?user='+userid) ;
    const responseJson = await response.json();
        return responseJson;
 }
 catch (e) {
...
export const division2=async(userid)=>
{
  try {
    const response = await fetch(BaseAPI+'MobileApp/getstaffdiv?user='+userid) ;
  const responseJson = await response.json();
      return responseJson;
 }
 catch (e) {
...
{
  console.log(BaseAPI+'/FeesReport?ayid='+ayid+'&div_id='+divid)
  try {
...
{
     try {
        const response = await fetch(BaseAPI+'Event/'+userid.substring(0, 7));
        const responseJson = await response.json();
        //console.log('DDAta'+JSON.stringify(responseJson))
        return responseJson;
    }
...
//for poll
export const insertpoll=async(data)=>
{  
  try {
...
{
     try {
        const response = await fetch(BaseAPI+'/Poll/GetStaffPollDetails?id='+userid);
        const responseJson = await response.json();
        return responseJson;
    }
    catch (e) {
...
export const savepollans=async(data)=>
{  
  try {
    const response=await fetch(BaseAPI+"/poll/SaveAnswer", {
    method: 'POST',
    headers: {
    'Content-Type': 'application/json; charset=utf-8',
    'dataType': 'json'
...
//pollstatus
export const getpollstatus=async (userid)=>
{
     try {
        const response = await fetch(BaseAPI+'/Poll/grvPollData?id='+userid);
        const responseJson = await response.json();
        return responseJson;
    }
    catch (e) {
...
export const getpollstatusdetails=async (userid)=>
{
     try {
        const response = await fetch(BaseAPI+'/Poll/pollStatus?id='+userid);
        const responseJson = await response.json();
        return responseJson;
    }
    catch (e) {
