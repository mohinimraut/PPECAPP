...
import { Image, ImageBackground, Text, ScrollView,TextInput, KeyboardAvoidingView, Keyboard, Alert, NetInfo,Dimensions,StatusBar ,Animated,} from 'react-native'
      ...
      if(isConnected){
       await this.vallidate();
        if(this.state.isError==false){
          ...
          console.log("responseLoginMohini---------",response)
         this.setState({
          typelogin:response.loginType,role_name:response.role_name
         })
